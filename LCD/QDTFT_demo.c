...
void Font_Test(void)
{
	...
	delay_ms(1000);
	Lcd_Clear(GRAY0);
	Gui_DrawFont_GBK16(16,30,RED,GRAY0,"温度:");
	...
	delay_ms(1800);	*/
	Gui_DrawFont_GBK24(10,50,RED,GRAY0,"温度");
	Gui_DrawFont_GBK24(10,86,RED,GRAY0,"湿度");
}
...
//取模方式 水平扫描 从左到右 低位在前
void showimage(const unsigned char *p) //显示128*160 QQ图片
{
  	int i; 
